...
import com.dht.services.question.KeywordQuetionServicesDecorator;
...
public class QuestionsController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        this.txtSearch.textProperty().addListener((e) -> {
            try {
                BaseQuestionServices s = new KeywordQuetionServicesDecorator(Configs.questionService, this.txtSearch.getText());
